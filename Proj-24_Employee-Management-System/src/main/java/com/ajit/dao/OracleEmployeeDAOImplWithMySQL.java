...
@Profile("prod")
public class OracleEmployeeDAOImplWithMySQL implements IEmployeeDAO {

	private static final String INSERT_EMP = "INSERT INTO EMPLOYEE2 (EID,ENAME,DEPT,SAL) VALUES (?,?,?,?)";
	
	private static final String SELECT_ALL_EMPS = "SELECT * FROM EMPLOYEE2";
	
	private static final String UPDATE_EMP = "UPDATE EMPLOYEE2 SET SAL=? WHERE EID=?";
	
	private static final String DELETE_EMP = "DELETE FROM EMPLOYEE2 WHERE EID=?";
