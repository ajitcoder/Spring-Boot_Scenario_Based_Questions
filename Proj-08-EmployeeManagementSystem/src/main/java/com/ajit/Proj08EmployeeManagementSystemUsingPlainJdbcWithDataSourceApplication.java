...
public class Proj08EmployeeManagementSystemUsingPlainJdbcWithDataSourceApplication {

    private final EmployeeController employeeController;

    Proj08EmployeeManagementSystemUsingPlainJdbcWithDataSourceApplication(EmployeeController employeeController) {
	...
	public static void main(String[] args) throws Exception {
		...
		try(ConfigurableApplicationContext ctx =
				SpringApplication.run(Proj08EmployeeManagementSystemUsingPlainJdbcWithDataSourceApplication.class, args);
